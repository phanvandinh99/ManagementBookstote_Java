...
// Dinh dang lai hien thi thong tin ngay gio ra man hinh
    ...
    private void btnThem_ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnThem_ActionPerformed
        ...
        SDT = txtSDT.getText();
        LoaiKhachHang =     project_Sem2.Project_SEM2.frmTC.GetCbbSelected(cbbLoaiKhachHang);
        ...
        if (kiemtra) {
           ...
           project_Sem2.Project_SEM2.frmTC.layDuLieuKhachHang();
             project_Sem2.Project_SEM2.frmTC.SetCbbKhachHangfrm(txtTenKhachHang.getText());
...
public boolean KiemTraNhapKhachHang(int ts) {
        ...
        if (ThongBao.equals("")) {
            ...
            kiemtra = false;
            project_Sem2.Project_SEM2.frmTC.ThongBao(ThongBao, "lỗi nhập liệu", 2);
        }
        return kiemtra;
    }
...
int tam=0;
    ...
    private void jPanel_KhachHangComponentShown(java.awt.event.ComponentEvent evt) {//GEN-FIRST:event_jPanel_KhachHangComponentShown
        ...
        project_Sem2.Project_SEM2.frmTC.layDuLieuKhachHang();
        cbbLoaiKhachHang.setModel(  project_Sem2.Project_SEM2.frmTC.LayDuLieucbb("LoaiKhachHang", "TenLoaiKhachHang", "MaLoaiKhachHang"));
        for (int i = 1; i < 32; i++) {
            cbbNgay.addItem(String.valueOf(i));
        }
        for (int i = 1; i < 13; i++) {
