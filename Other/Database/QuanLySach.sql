...
insert into ChuDe (TenChuDe) values (N'Truyện Nước Ngoài');
...
go
insert into NhaXuatBan (TenNXB, DiaChi, SDT) values (N'NXB Kim đồng',N'55 Quang Trung, Hai Bà Trưng, Hà Nội','02439434730');
insert into NhaXuatBan (TenNXB, DiaChi, SDT) values (N'NXB Trẻ',N'161B Lý Chính Thắng, Phường 7, Quận 3, Thành phố Hồ Chí Minh.','02839316289');
insert into NhaXuatBan (TenNXB, DiaChi, SDT) values (N'NXB Chính trị quốc gia',N'Số 24 Quang Trung, Hoàn Kiếm, Hà Nội.','028049221');
insert into NhaXuatBan (TenNXB, DiaChi, SDT) values (N'NXB Giáo dục',N'81 Trần Hưng Đạo, Hà Nội',' 02438220801');
insert into NhaXuatBan (TenNXB, DiaChi, SDT) values (N'NXB Lao động',N'175 Giảng Võ, Đống Đa, Hà Nội','02438515380');
insert into NhaXuatBan (TenNXB, DiaChi, SDT) values (N'NXB Hà Nội',N'Số 65 Nguyễn Du, Hà Nội','02438222135');
insert into NhaXuatBan (TenNXB, DiaChi, SDT) values (N'NXB Văn Học',N' P. Trúc Bạch, Q. Ba Đình, Tp. Hà Nội','842437161518');
go
...
(
	...
	TrangThai int default(0), --0: đã thanh toán, 1 mua nợ
)
go
create table Sach
(
...
go
insert into ChiTietDonHang (MaDonHang, MaSach, SoLuongMua, ThanhTien) values (1,2,2,400000);
insert into ChiTietDonHang (MaDonHang, MaSach, SoLuongMua, ThanhTien) values (1,3,2,400000);
insert into ChiTietDonHang (MaDonHang, MaSach, SoLuongMua, ThanhTien) values (1,1,2,400000);
go
...
go
insert into NhanVien (TaiKhoanNV, MatKhauNV, TenNhanVien, NgaySinh, GioiTinh, Email, SDT, QueQuan, TrangThai) 
values ('admin', 'admin123', 'Quản lý website', '2/2/1999', N'Nam', 'admin@gmail.com', '0971010281', N'Đà Nẵng', 0);
insert into NhanVien (TaiKhoanNV, MatKhauNV, TenNhanVien, NgaySinh, GioiTinh, Email, SDT, QueQuan, TrangThai) 
values ('kho', 'kho', 'Nhân Viên Kho', '2/2/1999', N'Nam', 'Kho@gmail.com', '0971010281', N'Đà Nẵng',0);
insert into NhanVien (TaiKhoanNV, MatKhauNV, TenNhanVien, NgaySinh, GioiTinh, Email, SDT, QueQuan, TrangThai) 
values ('admin3', 'admin123', 'Quản lý website', '2/2/1999', N'Nam', 'admin3@gmail.com', '0971010281', N'Đà Nẵng', 0);
insert into NhanVien (TaiKhoanNV, MatKhauNV, TenNhanVien, NgaySinh, GioiTinh, Email, SDT, QueQuan, TrangThai) 
values ('adm', 'admin123', 'Quản lý website', '2/2/1999', N'Nam', 'admin4@gmail.com', '0971010281', N'Đà Nẵng', 0);
insert into NhanVien (TaiKhoanNV, MatKhauNV, TenNhanVien, NgaySinh, GioiTinh, Email, SDT, QueQuan, TrangThai)  
values ('admin5', 'admin123', 'Quản lý website', '2/2/1999', N'Nam', 'admin5@gmail.com', '0971010281', N'Đà Nẵng', 0);
go
	--Bảng Phiếu Nhập--
...
go
insert into PhieuNhap (TenNhaCungCap, TaiKhoanNV, NgayNhapKho, TongTien) values ('1', 'admin', '7/7/2020', '8000000');
insert into PhieuNhap (TenNhaCungCap,  TaiKhoanNV, NgayNhapKho, TongTien) values ('2', 'admin', '3/2/2020', '8000000');
insert into PhieuNhap (TenNhaCungCap, TaiKhoanNV, NgayNhapKho, TongTien) values ('1', 'admin', '8/1/2019', '4000000');
insert into PhieuNhap (TenNhaCungCap, TaiKhoanNV, NgayNhapKho, TongTien) values ('4', 'admin', '2/2/2020', '8000000');
insert into PhieuNhap (TenNhaCungCap, TaiKhoanNV, NgayNhapKho, TongTien) values ('3', 'admin', '3/7/2018', '8000000');
insert into PhieuNhap (TenNhaCungCap, TaiKhoanNV, NgayNhapKho, TongTien) values ('1', 'admin', '7/7/2020', '8000000');
insert into PhieuNhap (TenNhaCungCap,  TaiKhoanNV, NgayNhapKho, TongTien) values ('6', 'admin', '8/9/2010', '8000000');
insert into PhieuNhap (TenNhaCungCap,  TaiKhoanNV, NgayNhapKho, TongTien) values ('5', 'admin', '3/4/2008', '8000000');
go
...
(
	...
	TenGiamGia varchar(10) not null,
	NoiDung nvarchar(100) null,
	PhanTram int default(20), --mặc định mgg có sẽ giảm 20%
	ToiDa money default(20), -- mặc định 20 lượt sử dụng
	LuotDung int default(0),
	DaDung int def
	NgayBatDau datetime default(getdate()) null,
	NgayKetThuc datetime null,
		constraint Check_NgayHieuLuc check (NgayKetThuc>=NgayBatDau),
	MaChuDe int null,
)
go
insert into GiamGia (TenGiamGia, NoiDung, PhanTram, ToiDa, LuotDung, NgayBatDau, NgayKetThuc, MaChuDe)
values ('MGGLT', N'Giảm 20% cho sách thuộc thể loại Lập Trình', 20, 50000, 20)
-- ======================================================= TRIGGER =======================================================--
...
go
 ...
 begin
	update Sach
	set SoLuongTon = SoLuongTon - (select SoLuongMua from inserted where MaSach = Sach.MaSach)
	from Sach
	join inserted
	on Sach.MaSach = inserted.MaSach
end
go
 ...
 begin
	...
	Set SoLuongTon = SoLuongTon + 
		(select SoLuongMua from deleted where MaSach=Sach.MaSach)
		from Sach
		join deleted
...
go
 ...
 begin
	update Sach
	set SoLuongTon = SoLuongTon - 
	(select SoLuongMua from inserted where MaSach = Sach.MaSach) +
	(select SoLuongMua from deleted where maSach = Sach.MaSach)
	from Sach
	join deleted
	on Sach.MaSach = deleted.MaSach
...
go
 ...
 begin
	update Sach
	set SoLuongDaBan = SoLuongDaBan + (select SoLuongMua from inserted where MaSach = Sach.MaSach)
	from Sach
	join inserted
	on Sach.MaSach = inserted.MaSach
end
go
 ...
 begin
	update Sach
	set SoLuongDaBan = SoLuongDaBan - (select SoLuongMua from deleted where MaSach = Sach.MaSach)
	from Sach
	join deleted
	on Sach.MaSach = deleted.MaSach
end
