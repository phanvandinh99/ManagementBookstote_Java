create database DataManagementBookStore
go
use DataManagementBookStore
go
create table Author
(
	Author_ID int identity (1,1) primary key,
	Author_Name nvarchar(100),
	Author_Address nvarchar(200),
	Author_Story nvarchar(100),
	Author_Phonenumber varchar(12)
)
go
insert into Author (Author_Name, Author_Address, Author_Story, Author_Phonenumber) values (N'Nam Cao',N'Hà Nam',N'một trong những nhà văn tiêu biểu thế kỷ 20','0971010282');
insert into Author (Author_Name, Author_Address, Author_Story, Author_Phonenumber) values (N'Xuân Diệu',N'Binh Định',N'ông hoàng thơ tình','072352456');
insert into Author (Author_Name, Author_Address, Author_Story, Author_Phonenumber) values (N'Nguyễn Du',N'Thăng Long',N'Đại thi hào dân tộc','0349758544');
insert into Author (Author_Name, Author_Address, Author_Story, Author_Phonenumber) values (N'Hoàng Thi Thơ',N'Quảng Trị',N'là một nhạc sĩ Việt Nam','0971010283');
insert into Author (Author_Name, Author_Address, Author_Story, Author_Phonenumber) values (N'Nguyễn Du',N'Hà Nội',N'Nhà văn học Việt Nam','0635241254');
go
create table Topic
(
...
go
insert into Topic (Topic_Name) values (N'Tin Học');
insert into Topic (Topic_Name) values (N'Văn Học');
insert into Topic (Topic_Name) values (N'Khoa Học');
insert into Topic (Topic_Name) values (N'Nhân Văn Học');
insert into Topic (Topic_Name) values (N'Kinh Tế');
insert into Topic (Topic_Name) values (N'Giáo Khoa');
insert into Topic (Topic_Name) values (N'Thiếu Nhi');
insert into Topic (Topic_Name) values (N'Nước Ngoài');
insert into Topic (Topic_Name) values (N'Truyện Nước Ngoài');
insert into Topic (Topic_Name) values (N'Sách Khác');
go
create table PublishingCompany
(
	PC_ID int identity(1,1) primary key,
	PC_Name nvarchar(50) not null,
	PC_Address nvarchar(200) not null,
	PC_Phonenumber varchar(12) not null,
)
go
insert into PublishingCompany (PC_Name, PC_Address, PC_Phonenumber) values (N'NXB Kim đồng',N'55 Quang Trung, Hai Bà Trưng, Hà Nội','02439434730');
insert into PublishingCompany (PC_Name, PC_Address, PC_Phonenumber) values (N'NXB Trẻ',N'161B Lý Chính Thắng, Phường 7, Quận 3, Thành phố Hồ Chí Minh.','02839316289');
insert into PublishingCompany (PC_Name, PC_Address, PC_Phonenumber) values (N'NXB Chính trị quốc gia',N'Số 24 Quang Trung, Hoàn Kiếm, Hà Nội.','028049221');
insert into PublishingCompany (PC_Name, PC_Address, PC_Phonenumber) values (N'NXB Giáo dục',N'81 Trần Hưng Đạo, Hà Nội',' 02438220801');
insert into PublishingCompany (PC_Name, PC_Address, PC_Phonenumber) values (N'NXB Lao động',N'175 Giảng Võ, Đống Đa, Hà Nội','02438515380');
insert into PublishingCompany (PC_Name, PC_Address, PC_Phonenumber) values (N'NXB Hà Nội',N'Số 65 Nguyễn Du, Hà Nội','02438222135');
insert into PublishingCompany (PC_Name, PC_Address, PC_Phonenumber) values (N'NXB Văn Học',N' P. Trúc Bạch, Q. Ba Đình, Tp. Hà Nội','842437161518');
go
create table Orders
(
	Order_ID int identity(1,1) primary key,
	Order_Customersname nvarchar(100) not null,
	Order_date date default(getdate()),
	Order_Totalmoney float not null,
	Order_Status int default(0), --0: đã thanh toán, 1 mua nợ
)
go
insert into Orders(Order_Customersname, Order_date, Order_Totalmoney, Order_Status) values (N'Phan Định', '02/09/2020', 350000,0);
insert into Orders(Order_Customersname, Order_date, Order_Totalmoney, Order_Status) values (N'Anh Thắng', '02/12/2020', 500000,0);
insert into Orders(Order_Customersname, Order_date, Order_Totalmoney, Order_Status) values (N'Huy', '11/12/2020', 200000,0);
go
create table Book
(
	...
	foreign key (PC_ID) references PublishingCompany(PC_ID) on delete cascade on update cascade,
	foreign key (Topic_ID) references Topic(Topic_ID) on delete cascade on update cascade,
)
go

insert into Book(Book_Name, Book_Price, Book_Description, Book_Images, Book_Dateupdate, Book_Quantily, PC_ID, Topic_ID, Book_Pricesold) 
...
- Theo dõi tình hình tài chính cá nhân bằng excel.',N'image_140616.jpg','01/01/2017','100','2','1', 20000);

insert into Book(Book_Name, Book_Price, Book_Description, Book_Images, Book_Dateupdate, Book_Quantily, PC_ID, Topic_ID, Book_Pricesold) 
values (N'XỬ LÝ ẢNH PHOTOSHOP CS5 ','80000',N'Dù bạn là người đã biết hay chưa từng sử dụng phần mềm này, bộ sách Photoshop CS5 dành cho người tự học gồm 4 tập là những tài liệu bạn cần có để trở thành một chuyên gia xử lý hình ảnh. Với những hướng dẫn, minh họa rõ ràng sẽ giúp bạn nắm vững và khám phá các đặc tính mới của Photoshop CS5 và ứng dụng trong công việc thực tế một cách hiệu quả nhất.',N'image_106956.jpg','06/06/2013','30','2','1', 20000);

insert into Book(Book_Name, Book_Price, Book_Description, Book_Images, Book_Dateupdate, Book_Quantily, PC_ID, Topic_ID, Book_Pricesold) 
values (N'CHÍ PHÈO ','35000',N'...Cả làng Vũ Đại nhao lên. Họ bàn tán rất nhiều về vụ án không ngờ ấy. Có kẻ mừng thầm. Không thiếu kẻ mừng ra mặt. Có người nói xa xôi: Trời có mắt đấy, anh em ạ!. Người khác thì nói toạc: Thằng nào chứ hai thằng ấy chết thì không ai tiếc! Rõ thật bọn chúng nó giết nhau, nào có phải cần đến tay người khác đâu...',N'image_67304.jpg','10/10/2014','5','7','2', 20000);
...
insert into Book(Book_Name, Book_Price, Book_Description, Book_Images, Book_Dateupdate, Book_Quantily, PC_ID, Topic_ID, Book_Pricesold) 
values (N'LUẬT NGÂN HÀNG NHÀ NƯỚC VIỆT NAM','6640',N'Luật Ngân Hàng Nhà Nước Việt Nam',N'image_79415.jpg','01/04/2014','15','3','5', 20000);

insert into Book(Book_Name, Book_Price, Book_Description, Book_Images, Book_Dateupdate, Book_Quantily, PC_ID, Topic_ID, Book_Pricesold) 
values (N'TÁC GIẢ TRONG NHÀ TRƯỜNG','60000',N'Bộ Sách Phê Bình Và Bình Luận Văn Học giới thiệu những bài viết của nhiều tác giả khác nhau về các "Tác Giả Trong Nhà Trường" như: Nam Cao, Xuân Diệu, Vũ Trọng Phụng, Nguyễn Trãi, Nguyễn Công Hoan, Nguyễn Đình Chiểu, Ngô Tất Tố, Tố Hữu, Hồ Xuân Hương và Nguyễn Du…',N'image_128447.jpg','01/04/2016','32','7','2', 20000);

insert into Book(Book_Name, Book_Price, Book_Description, Book_Images, Book_Dateupdate, Book_Quantily, PC_ID, Topic_ID, Book_Pricesold) 
values (N'TRUYỆN KIỀU', '75000', N'Ấn bản Truyện Kiều này là công trình khảo đính và chú giải của ông, một công trình được xem là mang tính khuôn mẫu choviệc xử lý các văn bản Hán-Nôm sau này do ông đảm nhiệm. Từ năm 1972 đến nay, bản Kiều này đã được tái bản 33 lần với số lượng hơn 200.000 bản, trở thành một trong các bản Kiều được tái bản nhiều nhất trong hơn bốn thập kỷ qua.', N'tk.jpg', '01/10/2017', '5','7','2', 20000);

insert into Book(Book_Name, Book_Price, Book_Description, Book_Images, Book_Dateupdate, Book_Quantily, PC_ID, Topic_ID, Book_Pricesold) 
values (N'HỒ CHÍ MINH THƠ VÀ ĐỜI','10000',N'Cuốn sách gồm hai phần:Phần một: tác phẩmPhần hai: về tác phẩm và cuộc đời Hồ Chí Minh.',N'hcmtvd.png','06/06/2016','15','7','2', 20000);

insert into Book(Book_Name, Book_Price, Book_Description, Book_Images, Book_Dateupdate, Book_Quantily, PC_ID, Topic_ID, Book_Pricesold) 
values (N'TỤC NGỮ, CA DAO, DÂN CA VIỆT NAM','58500',N'Tục Ngữ, Ca Dao, Dân Ca Việt Nam Xấu lá gói chẳng đặng nem Bởi anh chậm bước nên em có chồng Cá xuống sông còn mến nước trên đồng Sao em lấy chồng không ở vậy chờ anh?',N'tncdvn.jpg','01/12/2015','50','7','2', 20000);

insert into Book(Book_Name, Book_Price, Book_Description, Book_Images, Book_Dateupdate, Book_Quantily, PC_ID, Topic_ID, Book_Pricesold) 
values (N'MỌI CHUYỆN ĐỀU LÀ LỖI CỦA EM','40000',N'Những câu chuyện buồn nhưng nhìn từ một phương diện khác lại là thông điệp về hạnh phúc theo hướng tích cực. Đó là những tiếng yêu chân thành, nhẹ nhàng, dung dị và đầy thi vị',N'mcdllce.jpg','01/01/2018','40','6','4', 20000);

insert into Book(Book_Name, Book_Price, Book_Description, Book_Images, Book_Dateupdate, Book_Quantily, PC_ID, Topic_ID, Book_Pricesold) 
values (N'MỖI NGÀY NHÌN LẠI','80000',N'“Mỗi ngày tồn tại trên một thân xác khác nhau. Mỗi ngày sống một cuộc đời khác nhau. Nhưng dù vậy, mỗi ngày trôi qua vẫn chỉ yêu duy nhất một cô gái”',N'mnnl.jpg','01/01/2018','32','7','2', 20000);




insert into Book(Book_Name, Book_Price, Book_Description, Book_Images, Book_Dateupdate, Book_Quantily, PC_ID, Topic_ID, Book_Pricesold) 
values (N'THÁM TỬ LỪNG DANH CONAN - TẬP 94','35000',N'Dạo gần đây, Ran có những biểu hiện rất kì lạ... Trong lòng lo lắng không yên, Conan cùng thám tử Kogoro bắt đầu theo dõi cô...!? ',N'cn94.jpg','11/5/2018','100','1','7', 20000);

insert into Book(Book_Name, Book_Price, Book_Description, Book_Images, Book_Dateupdate, Book_Quantily, PC_ID, Topic_ID, Book_Pricesold) 
values (N'MẮT BIẾC','50000',N'"Tôi không thể bắt Hà Lan phải giống tôi.
Tôi khác. Không ai bắt tôi phải hoài vọng kỷ niệm.
 Không ai bắt tôi phải nhớ da diết cái làng nhỏ xa xăm của mình mỗi khi chiều xuống',N'mb.jpg','11/02/2011','15','2','2', 20000);
...
insert into Book(Book_Name, Book_Price, Book_Description, Book_Images, Book_Dateupdate, Book_Quantily, PC_ID, Topic_ID, Book_Pricesold) 
values (N'BẢY BƯỚC TỚI MÙA HÈ','40000',N'Câu chuyện về một mùa hè ngọt ngào, những trò chơi nghịch ngợm và bâng khuâng tình cảm tuổi mới lớn. Chỉ vậy thôi nhưng chứng tỏ tác giả đúng là nhà kể chuyện hóm hỉnh, khiến người đọc cuốn hút từ tựa đến trang cuối cùng, có lẽ chính vì giọng văn giản dị và trong trẻo của Nguyễn Nhật Ánh',N'bbdmh.jpg','01/03/2015','7','2','7', 20000);

insert into Book(Book_Name, Book_Price, Book_Description, Book_Images, Book_Dateupdate, Book_Quantily, PC_ID, Topic_ID, Book_Pricesold) 
values (N'NGỮ PHÁP TIẾNG ANH THỰC HÀNH ','79500',N'Ngữ Pháp Tiếng Anh Thực Hành gồm 5 chương, trình bày những chủ điểm ngữ pháp tiếng Anh từ cơ bản đến nâng cao, phù hợp với mọi trình độ',N'nptath.jpg','01/10/2016','34','7','8', 20000);

insert into Book(Book_Name, Book_Price, Book_Description, Book_Images, Book_Dateupdate, Book_Quantily, PC_ID, Topic_ID, Book_Pricesold) 
values (N'GIẢI THÍCH NGỮ PHÁP TIẾNG ANH','85000',N'Sách được biên soạn thành 18 chương, đề cập đến những vấn đề ngữ pháp từ cơ bản như: danh từ, đại từ, tính từ, trạng từ, so sánh tính từ và trạng từ, động từ, giới từ, cụm động từ, liên từ…',N'gtnpta.jpg','10/05/2016','4','4','8', 20000);

insert into Book(Book_Name, Book_Price, Book_Description, Book_Images, Book_Dateupdate, Book_Quantily, PC_ID, Topic_ID, Book_Pricesold) 
values (N'BỮA TIỆC CỦA PINKIE','80000',N'',N'btcp.jpg','11/11/2016','30','5','7', 20000);

insert into Book(Book_Name, Book_Price, Book_Description, Book_Images, Book_Dateupdate, Book_Quantily, PC_ID, Topic_ID, Book_Pricesold) 
values (N'Nhà Giả Kim (Tái Bản 2020)','20000',N'Tiểu thuyết Nhà giả kim của Paulo Coelho như một câu chuyện cổ tích giản dị, nhân ái, giàu chất thơ, thấm đẫm những minh triết huyền bí của phương Đông. Trong lần xuất bản đầu tiên tại Brazil vào năm 1988, sách chỉ bán được 900 bản. Nhưng, với số phận đặc biệt của cuốn sách dành cho toàn nhân loại, vượt ra ngoài biên giới quốc gia, Nhà giả kim đã làm rung động hàng triệu tâm hồn, trở thành một trong những cuốn sách bán chạy nhất mọi thời đại, và có thể làm thay đổi cuộc đời người đọc.',N'nhagiakim.jpg','11/11/2016','30','6','2', 20000);

-- Khoa Học
insert into Book(Book_Name, Book_Price, Book_Description, Book_Images, Book_Dateupdate, Book_Quantily, PC_ID, Topic_ID, Book_Pricesold) 
values (N'Bình Luận Khoa Học Hiến Pháp Hiện Hành (2013)','200000',N'Để triển khai thi hành Hiến pháp năm 2013, việc tuyên truyền, phổ biến và làm rõ các nội dung cụ thể của Hiến pháp năm 2013 qua các hình thức tìm hiểu, hỏi – đáp và đặc biệt là bình luận khoa học để làm sáng rõ nội dung của Hiến pháp hiện hành cho toàn dân là điều hất sức cần thiết, góp phần đưa Hiến pháp năm 2013 vào đời sống đạt hiệu quả cao. Nhà xuất bản Chính trị quốc gia Sự thật xuất bản và phát hành cuốn sách Bình luận khoa học Hiến pháp nước cộng hòa xã hội chủ nghĩa Việt Nam năm 2013.',N'binhluankhoahoc.jpg','11/2/2021','10','1','3', 20000);
...
Mặt tiện lợi đã thật sự rõ ràng, và cũng có thể vì thế mà chẳng mấy ai sẵn sàng nhìn vào mặt tối của Internet – nó đã khiến chúng ta phụ thuộc vào nó, biến đổi cách chúng ta tư duy, thậm chí làm thui chột trí tuệ của con người.',N'khoahocjkhampha.jpg','11/2/2021','10','1','3', 20000);

insert into Book(Book_Name, Book_Price, Book_Description, Book_Images, Book_Dateupdate, Book_Quantily, PC_ID, Topic_ID, Book_Pricesold) 
values (N'Cuộc Chiến Lỗ Đen','20000',N'- Ngọc hoàng và anh học trò nghèo',N'cuocchienloden.jpg','11/2/2021','10','1','3', 20000);

insert into Book(Book_Name, Book_Price, Book_Description, Book_Images, Book_Dateupdate, Book_Quantily, PC_ID, Topic_ID, Book_Pricesold) 
values (N'Khoa Học Khám Phá - Mật Mã','30000',N'Sách phác hoạ sự tiến hoá của mật mã từ khi nó xuất hiện cho tới nay và đồng thời là những chứng minh về sự hợp thời của nó.',N'matma.jpg','11/2/2021','10','1','3', 20000);
...
Bí mật lớn nhất của thời đại chúng ta là vẫn còn những lĩnh vực và phát minh mới cần chúng ta khám phá và tạo ra. Trong Không Đến Một, doanh nhân và nhà đầu tư huyền thoại Peter Thiel chỉ cho chúng ta biết cách tìm ra những cách thức độc đáo để tạo ra những thứ mới này.',N'khongdenmot.jpg','11/3/2021','10','6','4', 20000);
...
Kỹ năng bán hàng tuyệt đỉnh sẽ cho bạn đọc biết được những quy tắc bán hàng, vốn là điều kiện tiên quyết để gặt hái thành công trong bất kỳ lĩnh vực nào, với bất kỳ ai, bất kỳ ở đâu.',N'kynangbanhangtd.jpg','11/03/2011','25','4','5', 20000);
...
Vì sao nhân viên bán hàng rất mực chân thành nhưng lại không chiếm được thiện cảm của khách hàng?',N'chaohang.jpg','11/03/2011','25','4','5', 20000);
...
-- lập trình
insert into Book(Book_Name, Book_Price, Book_Description, Book_Images, Book_Dateupdate, Book_Quantily, PC_ID, Topic_ID, Book_Pricesold) 
values (N'ĐIỀU KHIỂN LOGIC LẬP TRÌNH PLC','35000',N'',N'dkltlg.jpg','12/11/2011','35','5','1', 50000);
...
Lập trình hướng đối tượng dựa trên việc tổ chức chương trình thành các lớp. Khác với hàm và thủ tục, lớp là một đơn vị bao gồm cả dữ liệu và các phương thức xử lý.',N'giaotrinhc.jpg', default,'5','5','1', 120000);
...
Không có những dòng lệnh logic khô cứng và dễ lỗi, những khái niệm kỹ thuật khó hiểu, những quy tắc luật lệ chằng chịt và mệt mỏi trong các ngôn ngữ lập trình kiểu người lớn.',N'tohoclaptrinh.jpg', default,'20','5','1', 60000);
...
Tương ứng với từng bài tập đều có mã (code) chương trình với những giải thích giúp người học dễ theo dõi, cho phép một người có kiến thức cơ bản về Điện - Điện tử có thể từ ba tới năm ngày thực hành là bắt đầu khai thác và sử dụng Arduino trong lập trình IOT.',N'Arduino.jpg', default,'20','5','1', 25000);
...
Minh họa độc đáo, ví dụ cụ thể, cùng những lời khuyên hữu ích, Ứng xử thông minh, lập trình sự nghiệp là cuốn sách chứa đựng đầy đủ những bài học cần biết về ứng xử và xây dựng hình ảnh bản thân dành cho những nhân viên trẻ, những người mới đi làm trong môi trường công sở.',N'laptrinhsunghiep.jpg', default,'20','5','1', 10000);
...
Phần 3: Xây dụng ứng dụng quản lý tuyển sinh',N'winform.jpg', default,'6','5','1', 10000);
...
Về tác giả của blog Tôi đi code dạo, anh tên thật là Phạm Huy Hoàng, một Developer Full Stack, cựu sinh viên trường FPT University, hiện tại anh đang học Thạc sĩ Computer Science tại Đại học Lancaster ở Anh (học bổng $18000). Trước khi qua Xứ Sở Sương Mù, anh đã từng làm việc tại FPT Software và ASWIG Solutions.',N'codedao.jpg', default,'9','5','1', 15000);

insert into Book(Book_Name, Book_Price, Book_Description, Book_Images, Book_Dateupdate, Book_Quantily, PC_ID, Topic_ID, Book_Pricesold) 
values (N'Chạy Đua Với Robot','35000',N'Nhân loại đang trải qua một cuộc cách mạng khác trong cách loài người làm việc và kiếm sống – và một lần nữa, cuộc cách mạng này lại đốt bỏ những điều tưởng chừng hiển nhiên của quá khứ trong đống tro tàn lịch sử. Một lần nữa, công nghệ mới đã tạo tiền đề cho cách mạng. Nhưng thay vì là hạt giống, là máy dệt, hay là đầu máy hơi nước; động cơ của cuộc cách mạng này là công nghệ kỹ thuật số và robot.',N'chayduavoirobot.jpg', default,'1','5','1', 45000);

insert into Book(Book_Name, Book_Price, Book_Description, Book_Images, Book_Dateupdate, Book_Quantily, PC_ID, Topic_ID, Book_Pricesold) 
values (N'Hello World - Làm Người Trong Kỷ Nguyên Máy Móc','35000',N'“Hello World” là một đoạn mang tính nghi thức của những người học lập trình, nhiệm vụ đầu tiên của một người mới học là lập trình sao cho máy tính hiện ra cụm từ này. Nhưng đồng thời nó cũng là một lời nhắc nhở về thời khắc của cuộc đối thoại giữa con người và máy tính trong kỷ nguyên máy móc, đánh dấu sự khởi đầu của một mối quan hệ mà một bên không thể tồn tại nếu thiếu bên kia.',N'helloword.jpg', default,'20','5','1', 65000);
...
• Ta có thể chuẩn bị gì cho kỉ nguyên AI?',N'ai.jpg', default,'20','6','1', 15000);
...
Nhưng, bằng những lập luận, bằng chứng thông minh, dí dỏm từ các ví dụ thực tiễn trong kinh tế, chính trị, thống kê xã hội học, Gary Smith sẽ chứng minh cho chúng ta thấy, nỗi lo sợ đó đầy màu sắc huyễn tưởng.',N'huyentuongvetrituenhantao.jpg', default,'2','5','1', 12000);

insert into Book(Book_Name, Book_Price, Book_Description, Book_Images, Book_Dateupdate, Book_Quantily, PC_ID, Topic_ID, Book_Pricesold) 
values (N'Phân Tích Dữ Liệu Với R (Tái Bản 2019)','35000',N'Cuốn sách bạn đang cầm trên tay là một nổ lực nhằm giới thiệu các phương pháp phân tích mô hình và thống kê phổ biến. các phương pháp gồm mô hình hồi qui tuyết tính, hồi qui logistic, phân tích tổng hợp (meta - anlysis), mô hình phân tích sống còn (survival anlysis), phương pháp phân tích chuỗi dữ liệu theo thời gian (time series data) phương pháp bayes, phương pháp bootstrap, v.v.. Với một nội dung khá rộng như thế, cuốn sách này sẽ giúp ích cho các nhà nghiên cứu, giảng viên cao đẳng và đại học, sinh viên, hay bất cứ ai muốn học về thống kê và phương pháp phân tích dữ liệu.',N'dulieur.jpg', default,'18','5','1', 5000);
...
go
insert into OrderDetails (Order_ID, Book_ID, OD_Quantity, OD_Intomoney) values (1,2,2,400000);
insert into OrderDetails (Order_ID, Book_ID, OD_Quantity, OD_Intomoney) values (1,3,2,400000);
insert into OrderDetails (Order_ID, Book_ID, OD_Quantity, OD_Intomoney) values (1,1,2,400000);
go
...
(
	...
	Participate_Role nvarchar(50),
	Participate_Position nvarchar(50),
	foreign key (Book_ID) references Book(Book_ID) on delete cascade on update cascade,
	foreign key (Author_ID) references Author(Author_ID) on delete cascade on update cascade,
)
go
insert into Participate (Book_ID, Author_ID, Participate_Role, Participate_Position) values (1, 1, N'Biên Soạn', 'Nhân Viên');
insert into Participate (Book_ID, Author_ID, Participate_Role, Participate_Position) values (2, 4, N'Biên Kiện', 'Nhân Viên');
insert into Participate (Book_ID, Author_ID, Participate_Role, Participate_Position) values (3, 2, N'Thiết Kế', 'Giám Sát');
insert into Participate (Book_ID, Author_ID, Participate_Role, Participate_Position) values (4, 4, N'CEO', 'Nhân Viên');
insert into Participate (Book_ID, Author_ID, Participate_Role, Participate_Position) values (5, 2, N'Quản Lý', 'Giám Đốc');
insert into Participate (Book_ID, Author_ID, Participate_Role, Participate_Position) values (3, 1, N'Thiết Kế', 'Nhân Viên');
go
Create table Role
(
...
go
insert into Role(Role_Name) values(N'Employee'); -- Nhân viên hoặc Admin
insert into Role(Role_Name) values(N'Warehouse Staff'); -- Nhân Viên Kho
go
Create table Staff
(
...
go
insert into ImportBook (Import_Name, Username, Import_Date, Import_Totalmoney) values ('1', 'admin', '7/7/2020', '8000000');
insert into ImportBook (Import_Name,  Username, Import_Date, Import_Totalmoney) values ('2', 'admin', '3/2/2020', '8000000');
insert into ImportBook (Import_Name, Username, Import_Date, Import_Totalmoney) values ('1', 'admin', '8/1/2019', '4000000');
insert into ImportBook (Import_Name, Username, Import_Date, Import_Totalmoney) values ('4', 'admin', '2/2/2020', '8000000');
insert into ImportBook (Import_Name, Username, Import_Date, Import_Totalmoney) values ('3', 'admin', '3/7/2018', '8000000');
insert into ImportBook (Import_Name, Username, Import_Date, Import_Totalmoney) values ('1', 'admin', '7/7/2020', '8000000');
insert into ImportBook (Import_Name,  Username, Import_Date, Import_Totalmoney) values ('6', 'admin', '8/9/2010', '8000000');
insert into ImportBook (Import_Name,  Username, Import_Date, Import_Totalmoney) values ('5', 'admin', '3/4/2008', '8000000');
go
...
go
insert into DetailImport (Import_ID, Book_ID, Amount, Price) values (1,1, 5, 180000);
insert into DetailImport (Import_ID,Book_ID, Amount, Price) values (1,2, 40, 180000);
insert into DetailImport (Import_ID,Book_ID, Amount, Price) values (2,1, 50, 180000);
go
-- ======================================================= TRIGGER =======================================================--
...
-- begin
--	update Book
--	Set Book_Quantily = Book_Quantily + (select Amount from inserted where Book_ID= Book.Book_ID)
--	from Book
--	Join inserted
...
-- begin
--	update Book
--	set Book_Quantily = Book_Quantily - (select OD_Quantity from inserted where Book_ID = Book.Book_ID)
--	from Book
--	join inserted
--	on Book.Book_ID = inserted.Book_ID
--end
...
-- begin
--	update Book
--	Set Book_Quantily = Book_Quantily + 
--		(select OD_Quantity from deleted where Book_ID=Book.Book_ID)
--		from Book
--		join deleted
...
--	update Book
--	set Book_Quantily = Book_Quantily - 
--	(select OD_Quantity from inserted where Book_ID = Book.Book_ID) +
--	(select OD_Quantity from deleted where Book_ID = Book.Book_ID)
--	from Book
--	join deleted
--	on Book.Book_ID = deleted.Book_ID
...
-- begin
--	update Book
--	set Book_Quantitysold = Book_Quantitysold + (select OD_Quantity from inserted where Book_ID = Book.Book_ID)
--	from Book
--	join inserted
--	on Book.Book_ID = inserted.Book_ID
--end
...
-- begin
--	update Book
--	set Book_Quantitysold = Book_Quantitysold - (select OD_Quantity from deleted where Book_ID = Book.Book_ID)
--	from Book
--	join deleted
--	on Book.Book_ID = deleted.Book_ID
--end
